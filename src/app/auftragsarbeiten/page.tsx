...
export default function AuftragsarbeitenPage() {
  return (
    ...
    >
      <h2 className="font-display text-2xl font-bold text-wood-walnut">Vom Anruf zum Möbelstück</h2>
      <ol className="mt-6 grid gap-4 md:grid-cols-4">
        {prozessSchritte.map((s) => (
          <li key={s.nr} className="rounded-2xl bg-wood-oak/15 p-5">
      ...
      <div className="mt-10 rounded-2xl bg-wood-walnut p-6 text-wood-raw sm:p-8">
        <h2 className="font-display text-xl font-bold">Was wir fertigen</h2>
        <ul className="mt-3 grid gap-2 text-sm text-wood-raw/80 sm:grid-cols-2">
